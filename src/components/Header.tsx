...
export default function Header() {
  ...
  return (
    <motion.header 
      className="fixed w-full top-0 left-0 right-0 z-50 bg-gray-900/80 backdrop-blur-md border-b border-gray-800"
    ...
    >
      <div className="w-full px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <motion.nav 
            className="hidden lg:flex items-center justify-center flex-1 space-x-8"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          >
            <motion.button
              ...
              className="text-gray-300 hover:text-white transition-colors duration-200 font-body relative group cursor-pointer"
          ...
          >
            {socialLinks.map((social, index) => (
              <motion.div
                ...
                whileHover={social.href ? { scale: 1.05 } : {}}
        ...
        {isMenuOpen && (
          ...
          >
            ...
            >
              <motion.button
                onClick={() => scrollToSection('hero')}
                className="block w-full text-left px-3 py-2 text-gray-300 hover:text-white transition-colors duration-200 font-body hover:bg-gray-700 rounded cursor-pointer"
                whileTap={{ scale: 0.95 }}
              >
                Home
              </motion.button>
